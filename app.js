...
function MainHeader() {
    ...
    if (isOpen === false) {
        return React.createElement(
            "div",
            { className: "headerC  headerSticky" },
            React.createElement(
                "div",
                null,
                React.createElement(
                ...
                React.createElement("img", { src: "borito.jpg", alt: "", style: { width: "80px", height: "120px" }, className: "center" })
            ),
            React.createElement(
                "nav",
                { className: scroll ? "notHiddenNav miniNav" : "hiddenNav miniNav" },
                React.createElement(
                    "button",
                    { className: "logo", onClick: function onClick() {
                            setIsOpen(!isOpen);
                        } },
                    React.createElement("i", { className: "bi bi-justify" })
                )
            )
        );
    } else {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    "div",
                    { className: " miniNav2 list-group" },
                    React.createElement(
                        "a",
                        { href: "#", className: "myNav2" },
                        " ",
                        React.createElement("i", { className: "bi bi-calculator-fill" }),
                        " Iskolaszerek"
                    ),
                    React.createElement(
                        "a",
                    ...
                    React.createElement(
                        ...
                        "T\xE1sk\xE1k/P\xE9nzt\xE1rc\xE1k"
                    ),
                    React.createElement(
                        "a",
                        { href: "#", className: "myNav2" },
                        " ",
                        React.createElement("i", { className: "bi bi-usb-drive" }),
                        " Egy\xE9b"
                    ),
                    React.createElement(
                        "a",
                        { href: "#", className: "myNav2" },
                        " ",
                        React.createElement("i", { className: "bi bi-person" }),
                        "Kapcsolatok"
                    )
                )
            )
...
function Header() {
    var _React$useState5 = React.useState(false),
        ...
        scroll = _React$useState6[0],
        setScroll = _React$useState6[1];
    ...
    return React.createElement(
        ...
        React.createElement(
            "nav",
            { style: { width: "965px", margin: "auto", padding: "0px" }, className: "navbar" },
            React.createElement(
                "a",
                { className: scroll ? "hiddenNav myNav" : "notHiddenNav myNav", href: "#" },
                " ",
                React.createElement("i", { className: "bi bi-calculator-fill" }),
                " Iskolaszerek"
            ),
...
function Body() {
    var _React$useState7 = React.useState("XXXX-ben nyitott meg a bolt, helyileg Püspökladányban található a xxxxx szám alatt."),
        _React$useState8 = _slicedToArray(_React$useState7, 2),
        szoveg = _React$useState8[0],
        setSzoveg = _React$useState8[1];
    ...
    return React.createElement(
        "div",
        { style: { borderLeft: "#1C641F ridge 2px", borderRight: "#7BC830 ridge 5px", padding: "10px" }, className: "shadow-lg rounded-bottom " },
        React.createElement(
            "div",
            { style: { padding: "15px" } },
            React.createElement(
                "select",
                { name: "select", id: "select", onChange: function onChange() {
                        setSzoveg(function (elozo) {
                            return elozo + 'szó';
                        });
                    } },
                React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "div",
                        { className: "slides" },
                        React.createElement("input", { type: "radio", name: "radio-btn", id: "radio1" }),
                        React.createElement("input", { type: "radio", name: "radio-btn", id: "radio2" }),
                        React.createElement("input", { type: "radio", name: "radio-btn", id: "radio3" }),
                        React.createElement(
                            "div",
                            { className: "slide first" },
                            React.createElement("img", { src: "borito.jpg", alt: "" })
                        ),
                        React.createElement(
                            "div",
                            { className: "slide" },
                            React.createElement("img", { src: "pava.jpg", alt: "" })
                        ),
                        React.createElement(
                            "div",
                            { className: "slide" },
                            React.createElement("img", { src: "teszt.png", alt: "" })
                        )
                    )
                )
            ),
